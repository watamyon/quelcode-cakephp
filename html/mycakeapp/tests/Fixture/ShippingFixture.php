...
class ShippingFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'bidder_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'item_id' => 1,
                'bidder_name' => 'Lorem ipsum dolor sit amet',
